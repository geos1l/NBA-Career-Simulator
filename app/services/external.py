...
from app.database import (
    ...
    get_career_stats as _db_get_career_stats,
    get_last_season_averages as _db_get_last_season_averages,
    get_name as _db_get_name,
    get_player_age as _db_get_player_age,
    get_player_bio as _db_get_player_bio,
...
# ---------------------------------------------------------------------------
# Utility functions — used by ingestion script and database layer
# ---------------------------------------------------------------------------
